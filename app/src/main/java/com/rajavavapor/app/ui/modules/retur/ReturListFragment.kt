...
import com.rajavavapor.app.databinding.FragmentReturBinding
import com.rajavavapor.app.util.ScreenHelper

class ReturListFragment : Fragment() {

    private var _binding: FragmentReturBinding? = null
    private val binding get() = _binding!!
    private val viewModel: ReturListViewModel by viewModels()
    private lateinit var adapter: ReturListAdapter

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentReturBinding.inflate(inflater, container, false)
        return binding.root
    }
